...
/**
 * 改造mybatis原生的注解，支持占位符配置，{@link org.mybatis.spring.annotation.MapperScan}
 *
 * @author buyi
 * @date 2017年11月30日下午12:19:42
 * @since 1.0.0
 */
@Retention(RetentionPolicy.RUNTIME)
@Target(ElementType.TYPE)
@Documented
@Import(PlaceHolderMapperScannerRegister.class)
public @interface PufferMapperScan {
